def fourLegSimulator(beta_list, gamma_list, beta_list2, gamma_list2, beta_list3, gamma_list3, beta_list4, gamma_list4, bodyHeight, femur, tibia):
    ...
    line, = ax.plot([], [], 'o-', lw=5, color='#e3f211')
    line2, = ax.plot([], [], 'o-', lw=5, color='#1b22e3')
    line3, = ax.plot([], [], 'o-', lw=5, color='#1b22e3')
    line4, = ax.plot([], [], 'o-', lw=5, color='#e3f211')
...
#     plt.plot(X1,Y1)
    ...
    plt.plot(X2_2,Y2_2,'blue')
#     plt.plot(X1_2,Y1_2)
    
    plt.plot(X2_3,Y2_3,'blue')
#     plt.plot(X1_3,Y1_3)
    
    plt.plot(X2_4,Y2_4,'green')
#     plt.plot(X1_4,Y1_4)
   
    
  
    plt.plot([-20,60],[-bodyHeight,-bodyHeight],'black')
    plt.plot([-4,44],[0,0],'red')
    plt.plot([-4,-4],[0,5],'red')
    plt.plot([44,44],[0,5],'red')
